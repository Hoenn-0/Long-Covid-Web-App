...
<html>
    ...
    <div id="outside">
        ...
        <form id="survey-form" action="patient.survey-inc.php" method="POST">        
                <fieldset>
                ...
                <fieldset>
                    ...
                    <div class="preCovid">
                         <p>Pre-Covid</p>
                            <select name="qPd1_1" style="border-radius: 15px; margin-left: 5px;">
                                <?php   for($i=0; $i<=12; $i++) { 
                                    if($i<=10){
                    ...
                    <div class="preCovid">
                         <p>Pre-Covid</p>
                            <select name="qPd1_2" style="border-radius: 15px; margin-left: 5px;">
                                <?php   for($i=0; $i<=12; $i++) { 
                                    if($i<=10){
                                    echo "<option value='$i'>$i</option>";
                                    }
                    ...
                    <div class="preCovid">
                         <p>Pre-Covid</p>
                            <select name="qPd1_3" style="border-radius: 15px; margin-left: 5px;">
                                <?php   for($i=0; $i<=12; $i++) { 
                                    if($i<=10){
                                    echo "<option value='$i'>$i</option>";
                                    }
                ...
                <fieldset>
                    ...
                    <p>Rate the severity of this problem (0 being not present, 10 being severe and life disturbing)</p>
                ...
                <fieldset>
                    ...
                    <select name="sq4" style="border-radius: 15px">
                            <?php   for($i=0; $i<=10; $i++) { 
                                echo "<option value='$i'>$i</option>";
                            }
                            ?>  
                ...
                <fieldset>
                    ...
                    <div class="preCovid">
                        <h4>Pre-Covid</h4>
                        <select name="qPd6" style="border-radius: 15px">
                            <?php   for($i=0; $i<=10; $i++) { 
                                echo "<option value='$i'>$i</option>";
                            }
                            ?>  
                ...
                <fieldset>
                    <h2>8. Anxiety</h2>
                        <p> On a 0-10 scale, how severe is any anxiety you are experiencing?</p>
                        <p>0 means I am not anxious, 10 means I have extreme anxious.</p>
               
                    <div class="preCovid">
                        <h4>Pre-Covid</h4>
                        <select name="qPd8" style="border-radius: 15px">
                            <?php   for($i=0; $i<=10; $i++) { 
                                echo "<option value='$i'>$i</option>";
                            }
                            ?>  
                ...
                <fieldset>
                    <h2>9. Depression</h2>
                        <p> On a 0-10 scale, how severe is any depression you are experiencing? </p>
                        <p>0 means I am not depressed, 10 means I have extreme depression</p>
                        
                    <div class="preCovid">
                        <h4>Pre-Covid</h4>
                        <select name="qPd9" style="border-radius: 15px">
                            <?php   for($i=0; $i<=10; $i++) { 
                                echo "<option value='$i'>$i</option>";
                            }
                            ?>  
                ...
                <fieldset>
                    ...
                    <div class="radio-toolbar">
                        ...
                        <input type="radio" id="7-2y" name="ptsdB" value="yes">
                        <label for="7-2y">Yes</label>

                        <input type="radio" id="7-2n" name="ptsdB" value="no">
                        <label for="7-2n">No</label>

                        <p>c) Have you tried to avoid thoughts or feelings about your illness or hospital admission?</p>
                        <input type="radio" id="7-2y" name="ptsdC" value="yes">
                        <label for="7-2y">Yes</label>

                        <input type="radio" id="7-2n" name="ptsdC" value="no">
                        <label for="7-2n">No</label>
                    </div>
                    ...
                    <div class="radio-toolbar">
                        ...
                        <input type="radio" id="10-1y" name="harm" value="yes">
                        <label for="10-1y">Yes</label>

                        <input type="radio" id="10-1n" name="harm" value="no">
                        <label for="10-1n">No</label>
                    </div>
                </fieldset>
                ...
                <fieldset>
                    ...
                    <div class="radio-toolbar">
                        ...
                        <input type="radio" id="10-1y" name="comms" value="yes">
                        <label for="10-1y">Yes</label>

                        <input type="radio" id="10-1n" name="comms" value="no">
                        <label for="10-1n">No</label>
                    </div>
                    <p>Rate the severity of communication problem (0 being not present, 10 being severe and life disturbing)</p>
                        <select name="qs11" style="border-radius: 15px">
                            <?php   for($i=0; $i<=10; $i++) { 
                                echo "<option value='$i'>$i</option>";
                            }
                            ?>  
                ...
                <fieldset>
                    ...
                    <div class="preCovid">
                        <h4>Pre-Covid</h4>
                        <select name="qPd12" style="border-radius: 15px">
                            <?php   for($i=0; $i<=10; $i++) { 
                                echo "<option value='$i'>$i</option>";
                            }
                            ?>  
                ...
                <fieldset>
                    ...
                    <div class="preCovid">
                        <h4>Pre-Covid</h4>
                        <select name="qPd13" style="border-radius: 15px">
                            <?php   for($i=0; $i<=10; $i++) { 
                                echo "<option value='$i'>$i</option>";
                            }
                            ?>  
                ...
                <fieldset>
                    ...
                    <div class="preCovid">
                        <h4>Pre-Covid</h4>
                        <select name="qPd14" style="border-radius: 15px">
                            <?php   for($i=0; $i<=10; $i++) { 
                                echo "<option value='$i'>$i</option>";
                            }
                            ?>  
                ...
                <fieldset>
                    ...
                    <div class="preCovid">
                        <h4>Pre-Covid</h4>
                        <select name="qPd15" style="border-radius: 15px">
                            <?php   for($i=0; $i<=10; $i++) { 
                                echo "<option value='$i'>$i</option>";
                            }
                            ?>  
                ...
                <fieldset>
                    ...
                    <div class="preCovid">
                        <h4>Pre-Covid</h4>
                        <select name="qPd16" style="border-radius: 15px">
                            <?php   for($i=0; $i<=10; $i++) { 
                                echo "<option value='$i'>$i</option>";
                            }
                            ?>  
                ...
                <div>
                    <p>Employment status before Covid-19 Lockdown:</p>
                    <label id="occupation" for="opt1"></label>
                    <input type="text" required id="finalQ" name="befLockdown" placeholder="Before Lockdown">   
                </div>

                <div>
                <p>Employment status before you became ill:</p>
                    <label id="occupation" for="opt1"></label>
                    <input type="text" required id="finalQ" name="befIll" placeholder="Before illness">   
                </div>
